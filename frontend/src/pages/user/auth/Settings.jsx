...
import { logoutUser, updatePassword } from "../../../redux/api/authApi";
...
function Settings() {
    ...
    const [changePassword, changePasswordResponse] = updatePassword();
    const [logout, logoutResponse] = logoutUser();
    ...
    const handleSubmitButton = (data) => {
        ...
        userData.set("currentPassword", data.currentPassword);
    ...
    }, [changePasswordResponse, dispatch, logout]);
       ...
       <div className="bg-white rounded-2xl shadow-2xl flex md:w-2/3 md:max-w-4xl max-w-full">
        <div className="md:w-3/5 p-5 ">
            <div className="text-left font-bold">
                ...
                <div className="py-10">
                    <h2 className="text-3xl font-bold text-green-500 mb-2">Change your password</h2>
                    <div className="border-2 w-10 border-green-500 inline-block mb-2"></div>
                    
                    <p className="text-gray-400 my-3">Set up a strong password</p>
                    <div className="flex flex-col items-center mb-3">
                        
                        <div className={`bg-gray-100 w-64 p-2 flex items-center mb-3 ${errors.currentPassword ? "border border-red-500": ""}`}>
                            <MdLockOutline className={`m-2 ${errors.currentPassword ? "text-red-500": "text-gray-400"}`} />
                            <input 
                            type="password" 
                            name="currentPassword"
                             ...
                             className={`bg-gray-100 outline-none text-sm flex-1 ${errors.currentPassword ? " placeholder:text-red-500" : ""}`} />
                        </div>
