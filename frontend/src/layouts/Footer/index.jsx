...
const Footer = () => {
	return (
		<footer className="w-full h-auto bg-primaryFooter !mt-0 ">
					...
					<div className="w-full p-2">
						...
						<ul className="space-y-3">
							<li className="flex items-center space-x-3">
								<GrLocation />
								<p>Lakhimpur, Uttar Pradesh</p>
							</li>
							<li className="flex items-center space-x-3">
								<FiPhoneCall />
								<a href="tel:+0123-456789" className="hover:text-secondary">
									+91 6386946873
								</a>
							</li>
							<li className="flex items-center space-x-3">
								<HiOutlineMail />
								<a
									href="mailto:devendrajohari9@gmail.com"
									className="hover:text-secondary"
								>
									devendrajohari9@gmail.com
								</a>
							</li>
							<li className="flex items-center space-x-3">
								<SocialLink />
			...
			<div className="h-36 lg:h-24 xl:h24 w-full bg-secondaryFooter">
