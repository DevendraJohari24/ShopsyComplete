...
const QuickViewProductModal = () => {
	...
	const { id, title, image, price, rating, reviews, discount, category } = product;
				...
				<div className="flex items-center max-lg:flex-col lg:gap-10 gap-4">
					...
					<div className="">
						...
						<div className="flex items-end max-lg:justify-center max-md:items-center mt-2">
							...
							<span className={`inline-block md:text-4xl text-3xl font-semibold text-greenBtn opacity-50 ${discount ? 'line-through' : ''} ml-4`}>
