...
const BannerSlideItem = ({ imgItem, index, isActive = true }) => {
	return (
		<>
			<img
			...
			/>
			<div className="absolute transition-colors delay-1000 bg bg-slate-900 bg-opacity-40 w-full h-full top-0 left-0 text-white">
				<div
