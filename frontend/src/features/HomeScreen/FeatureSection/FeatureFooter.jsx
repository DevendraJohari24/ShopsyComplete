...
const FeatureFooter = () => {
	...
	return (
		<div className='relative px-4 sm:px-8 md:px-8 lg:px-8 xl:px-8 w-full before:z-0 before:contents-[""] before:w-full before:h-1/2 before:absolute before:left-0 before:bottom-0 before:bg-primaryFooter'>
			<div
